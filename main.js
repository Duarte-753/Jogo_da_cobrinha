...
// Adicionar o manipulador de eventos ao botão novo jogo
  ...
  function update() {
    ...
    if (head.x === food.x && head.y === food.y) {
      ...
      // Acelerar o jogo gradativamente
  ...
  function gameOver() {
    ...
    context.fillText('Fim de Jogo!', canvas.width / 3.3 - 100, canvas.height / 2);
    context.fillText('Não bate nas laterais ', canvas.width / 5- 100, canvas.height /2 +80);
    context.fillText('ou encoste no corpo da', canvas.width / 5.5- 100, canvas.height /2 +160);
    context.fillText('cobrinha!', canvas.width / 5.5- 100, canvas.height /2 +240);
  }

  // Função para encerrar o jogo se acabar o tempo
  function acabouTempo() {
    ...
    context.fillStyle = 'red';
    context.font = '80px Arial';
    context.fillText('Acabou o tempo :( ', canvas.width / 3.5 - 100, canvas.height / 2);
    context.fillText('Coma as maças para ter', canvas.width / 5 - 100, canvas.height /2 +80);
    context.fillText('mais tempo!', canvas.width / 5.5 - 100, canvas.height /2 +160);
  }
